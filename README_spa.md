...
**Proyectos Hijos** — cada uno es una etapa específica o un consumidor del propio pipeline de percepción Hailo-8 de este nodo
...
- **[HYDRA-UMC](https://github.com/JuanenRac/HYDRA-UMC)** — la placa madre física del brazo robótico: host CM5 + coprocesador STM32H745 de doble núcleo, coordinando hasta 8 brazos herramienta por CAN-OTA/SPI-OTA; el propio pipeline de percepción de este nodo es lo que cierra el bucle de seguridad/E-STOP sobre ese firmware.
- **[HYDRA-UMC-COGNITIVE-NODE](https://github.com/JuanenRac/HYDRA-UMC-COGNITIVE-NODE)** — nodo de integración para el pipeline cognitivo Hailo-10 (orquestación de LLM/VLA/voz), construido como la capa semántica directamente sobre la propia salida de percepción de este nodo.
