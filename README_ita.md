...
**Genitore:** nessuno — questo progetto è esso stesso il genitore di integrazione della famiglia Vision AI Node.
...
- **[HYDRA-UMC](https://github.com/JuanenRac/HYDRA-UMC)** — chiude il loop percezione/E-STOP su questo firmware.
- **[HYDRA-UMC-COGNITIVE-NODE](https://github.com/JuanenRac/HYDRA-UMC-COGNITIVE-NODE)** — lo strato semantico costruito sopra questa percezione.
