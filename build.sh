#!/usr/bin/env bash
# =============================================================================
# HYDRA-UMC-VISION-NODE - build.sh
# Copyright (C) 2026 JuanenRac (Electro Hobby 3D) <electrohobby3d@gmail.com>
# GPL-3.0 - see LICENSE
# =============================================================================
# Builds HYDRA-UMC-VISION-NODE: creates/activates a venv, installs the
...
echo
echo " ==============================================================="
echo "  H Y D R A - U M C - V I S I O N - N O D E  -  build"
echo " ==============================================================="
echo "  High-speed perception edge AI node (Hailo-8 + CM5)"
...
python -c "import hydra_umc_vision_node; print('import OK')"
echo "      Done."
echo
